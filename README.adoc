...
* link:https://github.com/bbertka/code-server-eks#part-4---set-up-persistent-file-system[Setup EFS for file persistence]
* link:https://github.com/bbertka/code-server-eks#part-5---deploy-code-server[Deploy code-server]
* link:https://github.com/bbertka/code-server-eks#part-6---connect-to-your-ide[Connect to your IDE]
* link:https://github.com/bbertka/code-server-eks#part-7---using-your-ide[Using your IDE]
* link:https://github.com/bbertka/code-server-eks#part-8---testing-your-ide[Testing your IDE]
