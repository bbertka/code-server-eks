...
1. Navigate to the side bar and Open a new Terminal shell

image:images/terminal.png[]

2. You will be presented with an empty terminal 

image:images/terminal-new.png[]

3. Navigate to the ~/project folder and clone a GIT repo

image:images/clone-repo.png[]

4. Use the GUI to create a text file

image:images/clone-repo.png[]

= Part 7 - Delete the Deployment and re-delpoy, ensure Persistence
...
== Congratulations! You have deoployed a stateful VSCode instance on EKS
