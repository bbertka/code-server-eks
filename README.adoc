...
* link:https://github.com/bbertka/code-server-eks#part-6---connect-to-your-ide[Part 6 - Connect to Code-server]
* link:https://github.com/bbertka/code-server-eks#part-7---using-your-ide[Part 7 - Using Code-server]
